                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(24, 0, 20, 0),
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              ...
                              child: InkWell(
                                onTap: () async {
                                  context.pushNamed(
                                    'ActivoPerfilPage',
                                    queryParams: {
                                      'activoDatos': serializeParam(
                                        functions.buscarActivoPorID('id'),
                                        ParamType.String,
                                      ),
                                    }.withoutNulls,
                                    extra: <String, dynamic>{
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title: Text(
                                                                'Advertencia'),
                                                            content: Text(
                                                                '¿Esta completamente seguro que desea quitar este activo?'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
